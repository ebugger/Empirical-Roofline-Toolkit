...
import rooflineviewpart.views.RooflineChart.Roofline;
import rooflineviewpart.views.RooflineChart.TerryRoofline;
...
public class RooflineDataManager {
	...
	public static List<TerryRoofline> getRemoteRooflines(String baseurl){
		List<String> topDirs = getFiles(baseurl,null,true);
		List<String> jsonFiles;
		List<TerryRoofline> rooflines = new ArrayList<TerryRoofline>();
		for(String url: topDirs){
			...
			for(String file: jsonFiles){
        		...
        		Gson gson = new Gson();
				 TerryRoofline RL = gson.fromJson(br, TerryRoofline.class);
